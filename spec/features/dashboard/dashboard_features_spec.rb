...
describe 'user' do
  context 'visiting /dashboard' do
    ...
    it 'sees the top 3 companies ranked by level_of_interest with their average_level_of_interest' do
      company_1 = Company.create!(name: "ESPN")
      company_2 = Company.create!(name: "COOL")
      company_3 = Company.create!(name: "Sad")
      category = Category.create!(name: 'sdgfd')
      ...
      job_4 = company_2.jobs.create!(title: "Acctuary", description: 'sdgfsa', level_of_interest: 4, city: "New York City", category_id: category.id)
